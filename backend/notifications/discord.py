...
async def send_discord_signal(signal: dict[str, Any]) -> None:
    ...
    embed = {
        ...
        "fields": [
            ...
            {"name": "Prices",            "value": bid_ask,                             "inline": True},
            {"name": "Model Probability", "value": model_prob_pct,                      "inline": True},
            {"name": "Edge",              "value": edge_pct,                            "inline": True},
            {"name": "Expected Value",    "value": ev_pct,                              "inline": True},
            {"name": "Suggested Size",                    "value": size_dollars,                           "inline": True},
